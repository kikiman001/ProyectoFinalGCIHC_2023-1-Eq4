...
int main()
{
	...
	//	3
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(11.5f, 0.0f, 0.3f));
		...
		model = glm::mat4(1);
		model = glm::translate(tmp, glm::vec3(-1.0f, 3.323f, 0.0f));
		...
		model = glm::rotate(model, glm::radians(Abrir), glm::vec3(0.0f, -1.0f, 0.0));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1f(glGetUniformLocation(lightingShader.Program, "transparencia"), 0.0);
		...
		glUniform4f(glGetUniformLocation(Anim2.Program, "colorAlpha"), 1.0f, 1.0f, 1.0f, 1.0f);
		glUniform1f(glGetUniformLocation(Anim2.Program, "transparencia"), 0.0);
		DomoC.Draw(Anim2);
