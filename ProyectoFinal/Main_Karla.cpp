...
// Keyframes
float posX =PosIni.x, posY = PosIni.y, posZ = PosIni.z, rotRodIzq = 0, rotAlaIzq = 0;
...
void saveFrame(void)
{
	...
	KeyFrame[FrameIndex].rotAlaIzq = rotAlaIzq;
...
void resetElements(void)
{
	...
	rotAlaIzq = KeyFrame[0].rotAlaIzq;
}
...
void interpolation(void)
{
	...
	KeyFrame[playIndex].rotInc2 = (KeyFrame[playIndex + 1].rotAlaIzq - KeyFrame[playIndex].rotAlaIzq) / i_max_steps;
}
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Proyecto Final 2023-1", nullptr, nullptr);
	...
	Model Pescado((char*)"Models/Pescado/Pescado.obj");
	...
	Model Pingu((char*)"Models/Pinguino/Pingu.obj");
	Model Ala_izq((char*)"Models/Pinguino/Ala_izq.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "dirLight.ambient"), 0.50f, 0.50f, 0.50f);
		...
		tmp = model = glm::translate(model, glm::vec3(1, 1, 0));
		model = glm::translate(model, glm::vec3(20.0f, -3.0f, 0.0f));
		model = glm::rotate(model, glm::radians(rot), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 1.0f, 0.0));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		Pescado.Draw(lightingShader);

		//4. Letrero
		view = camera.GetViewMatrix();
		model = glm::scale(model, glm::vec3(2.0f, 2.5f, 3.0f));
		tmp = model = glm::translate(model, glm::vec3(1, 1, 1));
		model = glm::translate(model, glm::vec3(8.0f, -2.0f, 28.0f));
		model = glm::rotate(model, glm::radians(rot), glm::vec3(0.0f, 1.0f, 0.0));
		...
		tmp = model = glm::translate(model, glm::vec3(1, 1, 1));
		model = glm::rotate(model, glm::radians(rot), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::rotate(model, glm::radians(-rotAlaIzq), glm::vec3(1.0f, 0.0f, 0.0));
		model = glm::translate(model, glm::vec3(-1.0f, -1.0f, -1.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		Ala_izq.Draw(lightingShader);
		...
		//7. Rampa
		view = camera.GetViewMatrix();
		model = glm::scale(model, glm::vec3(15.f, 10.0f, 20.1f));
		tmp = model = glm::translate(model, glm::vec3(1, 1, 1));
		model = glm::translate(model, glm::vec3(3.0f, -1.0f, -10.0f));
		model = glm::rotate(model, glm::radians(rot), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		Rampa.Draw(lightingShader);
