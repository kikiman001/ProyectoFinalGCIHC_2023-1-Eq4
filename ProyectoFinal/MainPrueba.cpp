...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Animacion I", nullptr, nullptr);
	...
	Model Crab((char*)"Models/Cangrejo/Crab.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//glBindVertexArray(0);*/
		/*
		Forma de animacion por shader
		usando trigonometria con amplitud y escala
		...
		*/
		...
		glUniform1f(glGetUniformLocation(shader.Program, "time"), tiempo);
